...
attach(ConcHidalgo) #this is for not writing the name of the data frame and the $ ever time

#Sort Conc according to INGCOR, FOLIOVIV, FOLIOHOG
ConcHidalgo<- orderBy (~+ing_cor+folioviv+foliohog, data=ConcHidalgo) #this give us the households sorted by total income

#Adding the values of the expansion FACTOR. The sum is 34 million, which is the number of households in the country.
tot_hogares<-sum(ConcHidalgo$factor,to.data.frame=TRUE)
...
ConcHidalgo$tam_dec<-tam_dec

# Creating Deciles of Income 

ConcHidalgo$MAXT<-ConcHidalgo$ing_cor #vamos a crear en esta base la variable MAXT que es una copia de la columna de ingresos

ConcHidalgo<-ConcHidalgo[with(ConcHidalgo, order(rank(MAXT))),]  #lo que hicimos aqu? fue reordenar la base con respecto a MAXT. Cosa que en realidad, ya estaba.

ConcHidalgo$ACUMULA<-cumsum(ConcHidalgo$factor) #aqu? creamos una variable de suma acumulada del FACTOR de viviendas.
...
for(i in 1:9)
{
  a1<-ConcHidalgo[dim(ConcHidalgo[ConcHidalgo$ACUMULA<tam_dec*i,])[1]+1,]$factor
  ConcHidalgo<-rbind(ConcHidalgo[1:(dim(ConcHidalgo[ConcHidalgo$ACUMULA<tam_dec*i,])[1]+1),],
                      ConcHidalgo[(dim(ConcHidalgo[ConcHidalgo$ACUMULA<tam_dec*i,])[1]+1):dim(ConcHidalgo[1])[1],])
  
  b1<-tam_dec*i-ConcHidalgo[dim(ConcHidalgo[ConcHidalgo$ACUMULA<tam_dec*i,])[1],]$ACUMULA
  ConcHidalgo[(dim(ConcHidalgo[ConcHidalgo$ACUMULA<tam_dec*i,])[1]+1),]$factor<-b1
  ConcHidalgo[(dim(ConcHidalgo[ConcHidalgo$ACUMULA<tam_dec*i,])[1]+2),]$factor<-(a1-b1)
}

#aqu? estamos creando otra variable de suma acumulada del n?mero de hogares
ConcHidalgo$ACUMULA2<-cumsum(ConcHidalgo$factor)
...
ConcHidalgo[(ConcHidalgo$ACUMULA2<=tam_dec),]$DECIL<-1
...
for(i in 1:9)
{
  ConcHidalgo[((ConcHidalgo$ACUMULA2>tam_dec*i)&(ConcHidalgo$ACUMULA2<=tam_dec*(i+1))),]$DECIL<-(i+1)
}

# a lo que le qued? cero (que es la ?ltima observaci?n), ponle el decil 10
ConcHidalgo[ConcHidalgo$DECIL%in%"0",]$DECIL<-10

setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Hidalgo")
write.dbf(ConcHidalgo,file="ConcHidalgo2010.dbf")
...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Hidalgo")
write.dbf(ConcHidalgo,file="ConcHidalgo2018.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Hidalgo")
Conc2010<-read.dbf("ConcHidalgo2010.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Hidalgo por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Hidalgo por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Hidalgo por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Hidalgo por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Hidalgo por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Hidalgo INDIGENA por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Hidalgo INDIGENA por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Hidalgo INDIGENA por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Hidalgo INDIGENA por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Hidalgo INDIGENA por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Hidalgo NO por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Hidalgo NO por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Hidalgo NO por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Hidalgo NO por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Hidalgo NO por fuente por DECIL LS 2010.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Hidalgo")
Conc2018<-read.dbf("ConcHidalgo2018.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Hidalgo Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Hidalgo Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Hidalgo Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Hidalgo Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Hidalgo Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Hidalgo INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Hidalgo INDIGENA Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Hidalgo INDIGENA Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Hidalgo INDIGENA Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Hidalgo INDIGENA Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Hidalgo NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Hidalgo NO Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Hidalgo NO Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Hidalgo NO Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Hidalgo NO Ingresos por fuente por DECIL LS 2018.dbf")
...
Deciles2010<-read.dbf("Hidalgo por fuente por DECIL estimaciones 2010.dbf")
names(Deciles2010)[1]<-c("ingcor2010")

Deciles2018<-read.dbf("Hidalgo Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010No<-read.dbf("Hidalgo NO por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010No)[1]<-c("No2010")

deciles2018No<-read.dbf("Hidalgo NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010indigena<-read.dbf("Hidalgo INDIGENA por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010indigena)[1]<-c("Indigena2010")

deciles2018indigena<-read.dbf("Hidalgo INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
